...
- **Anti-patterns #19, #24** (banning `รีบสมัครเลย!` and generic emotional
...
(`รีบสมัครเลย!`). Anti-pattern #19 *softened*: a single `!` at hook or CTA is fine
...
**Closings**: capability summary or contact CTA. No emotional appeal. Anti-patterns
#19 and #24 apply at full bank-explainer strictness.
...
**Closings**: forward-looking advisory. Anti-patterns #19, #24 apply at full
strictness.
...
**Closings**: feature CTA or signposting next read. Anti-pattern #19 *softened*:
